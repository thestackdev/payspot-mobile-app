...
type Props = NativeStackScreenProps<RootStackParamList, 'AEPSScreen'>;

export default function AEPSScreen({navigation, route}: Props) {
  ...
  const banksList = useMerchantStore(state => state.merchant?.banks_list) || [];
